		...
		<div class="container">
			...
			<div class="col-md-3 header-right"> 
				<div class="search-bar">
					<form action="<%=request.getContextPath() %>/watch/selects">
			...
			<div class="about-top grid-1">
				<div class="col-md-4 about-left">
					<figure class="effect-bubba">
						<img class="img-responsive" src="<%=request.getContextPath()%>/static/images/abt-1.jpg" alt=""/>
						<figcaption>
				...
				<div class="col-md-4 about-left">
					<figure class="effect-bubba">
						<img class="img-responsive" src="<%=request.getContextPath()%>/static/images/abt-2.jpg" alt=""/>
						<figcaption>
				...
				<div class="col-md-4 about-left">
					<figure class="effect-bubba">
						<img class="img-responsive" src="<%=request.getContextPath()%>/static/images/abt-3.jpg" alt=""/>
						<figcaption>
	...
	<div class="product"> 
		<div class="container">
			<div class="product-top">
				...
				<c:forEach items="${list }" var="watch" varStatus="status"> 
					<div class="col-md-3 product-left">
						<div class="product-main simpleCart_shelfItem"> 
							<a href="<%=request.getContextPath()%>/watch/details?id=${watch.id}" class="mask">
								<img class="img-responsive zoom-img" src="<%=request.getContextPath()%>/static/images/${watch.img}" alt="" /></a>
							<div class="product-bottom">
								<h3>${watch.name}</h3>
								<h4><a class="item_add" href="#"><i></i></a> <span class="${watch.price}">${watch.price}</span></h4>
							</div>
						</div>
					</div>
				</c:forEach>
            ...
            <td colspan="6" align="center" bgcolor="#5BA8DE">共${page.totalRecords}条记录 共${page.totalPages}页 当前第${page.pageNo}页<br>            
                ...
                <c:choose>
                  <c:when test="${page.pageNo!=1}">             
                      <a href="<%=request.getContextPath()%>/watch/list?pageNo=${page.previousPageNo }"><input type="button" name="previousPage" value="上一页" /></a>                
                  </c:when>
                  <c:otherwise>   
                ...
                <c:choose>
                  <c:when test="${page.pageNo != page.totalPages}">
                    <a href="<%=request.getContextPath()%>/watch/list?pageNo=${page.nextPageNo }"><input type="button" name="nextPage" value="下一页" /></a>
                  </c:when>
                  <c:otherwise>    
